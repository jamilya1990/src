...
public class Post {
    private String body;
    private final String DATE_TIME;//LocalDateTime.now().format(DateTimeFormatter.ofPattern("MMM dd, yyyy | hh:mm a"));

    public Post(String body){
        this.body=body;
        // setting up/assigning value to DATE_TIME final variable
